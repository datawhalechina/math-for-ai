...
(\boldsymbol{A}+\boldsymbol{B})\boldsymbol{C}=\boldsymbol{A}\boldsymbol{B}+\boldsymbol{A}\boldsymbol{C}, \tag{2.19a}\\
...
> **例2.4**
> 矩阵 $$\boldsymbol{A}= \left [ \begin{matrix} 1&2&1\\ 4&4&5\\ 6&7&7 \end{matrix} \right ],  \boldsymbol{B}= \left [ \begin{matrix} -7&7&6\\ 2&1&-1\\ 4&5&-4 \end{matrix} \right ] \tag{2.25}$$ 互为逆矩阵，因为 $\boldsymbol{AB}=\boldsymbol{BA}=\boldsymbol{I}$。
...
$$
\begin{align}
\boldsymbol{A}\boldsymbol{A}^{-1}=\boldsymbol{A}^{-1}\boldsymbol{A}_n=\boldsymbol{I} \tag{2.26}
